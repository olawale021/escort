    ...
    return (
        <>
            ...
            <div className="ratecard-container">
                ...
                <p>
                    Indulge in the ultimate experience, where passion, connection, and satisfaction are guaranteed. My rates reflect the quality of attention, intimacy, and care that you deserve.
                </p>

                <section>
                    <h2>Signature Full Satisfactory Girlfriend Experience (GFE)</h2>
                    <ul>
                        <li>A deeply relaxing Massage to soothe your body and awaken your senses.</li>
                        <li>An intimate, uninhibited Bareback Blowjob for raw, electrifying connection.</li>
                        <li>The option for Greek, an adventurous and sensual exploration.</li>
                        <li>Multiple Shots of Orgasm, ensuring your satisfaction is truly limitless.</li>
                    </ul>
                </section>
