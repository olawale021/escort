...
const Homepage = () => {
    ...
    const carouselImages = {
        ...
        mobile: [
            "https://firebasestorage.googleapis.com/v0/b/exchange-a72f2.appspot.com/o/WM.jpeg?alt=media&token=f0a4c623-ebe7-415c-8a37-87c3b26cd321",
        ...
        <div className="page-container">
            ...
            <div className="hero-container">
                ...
                <div className="hero-overlay">
                    ...
                    <button className="hero-button" onClick={openChat}>Book Me</button>
                </div>
            </div>
            ...
            <div className="welcome-section">
                ...
                <div className="welcome-cta">
                    ...
                    <p>If we haven't had the pleasure of meeting yet, let's chat and create something special
                        together.</p>
                    <button className="chat-button" onClick={openChat}>Let's Chat</button>
                </div>
            </div>
            <Footer />
        </div>
